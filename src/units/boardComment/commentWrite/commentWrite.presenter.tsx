  ...
  return (
    <C.Entire>
        <C.CommentWrapper>
          ...
          <C.CommentHeader>
            <C.CommentWriter type="text" placeholder="작성자" onChange={props.onWriterCheck}/>
            <C.CommentPassword type="password" placeholder="비밀번호" onChange={props.onPwCheck}/>
          </C.CommentHeader>
          <C.CommentInput
            type="text"
          ...
          />
          <C.CommentBtnBox>
            <C.CommentBtn onClick={props.onClickNewComment}>등록하기</C.CommentBtn>
          </C.CommentBtnBox>
        </C.CommentWrapper>
    </C.Entire>
  )
